...
public class SplineInspector : Editor
{
    ...
    {
        Object[] SceneObjects = Object.FindObjectsOfType(typeof(Object)) as Object[];
        Undo.RecordObjects(SceneObjects, "Add Node To " + spline.name);
    ...
    {
        Object[] SceneObjects = Object.FindObjectsOfType(typeof(Object)) as Object[];
        Undo.RecordObjects(SceneObjects, "Add CtrlNode-Component To " + spline.name + "'s children");
        ...
        foreach (Transform node in splineNodes)
        {
            ...
            switch (Tools.current)
            {
                ...
                case Tool.Rotate:
                    ...
                    Undo.RecordObject((Object)node, "Rotate Spline Node: " + node.name);
                ...
                case Tool.Move:
                    ...
                    Undo.RecordObject((Object)node, "Move Spline Node: " + node.name);
    ...
    private void CreateSnapshot()
    {
        ...
        {
            Object[] SceneObjects = Object.FindObjectsOfType(typeof(Object)) as Object[];
            Undo.RecordObjects(SceneObjects, "Create snapshot");
            Undo.RecordObjects(SceneObjects, "Register snapshot");
        }
    }
    ...
    {
        Object[] SceneObjects = Object.FindObjectsOfType(typeof (Object)) as Object[];
        Undo.RecordObjects(SceneObjects, "Create new spline");
